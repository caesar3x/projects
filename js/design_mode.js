...
{
	jQuery.ajaxRequest(fn_url('design_mode.update_langvar'), {method: 'post', data: {langvar_name: window['_translate_obj'].var_name, langvar_value: $('#trans_val').val(), lang_code: window['_translate_lang_code']}});
