...
//
	...
	$product_options = db_get_array("SELECT p.*, d.* FROM ?:product_options as p LEFT JOIN ?:product_options_descriptions as d ON d.option_id = p.option_id AND d.lang_code = ?s WHERE p.product_id = 0 $condition ORDER BY position", DESCR_SL);
	$view->assign('product_options', $product_options);
