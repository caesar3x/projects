...
fn_set_hook('get_skin_path', $area, $dir_skins);
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if ($mode == 'edit') {
		...
		if (strpos($fname, $dir_skins) !== false && @is_writable($fname) && !in_array(strtolower(fn_get_file_ext($fname)), Registry::get('config.forbidden_file_extensions'))) {
...
if ($mode == 'browse') {
	...
	if (!in_array(strtolower(fn_get_file_ext($file)), Registry::get('config.forbidden_file_extensions'))) {
	...
	if (in_array(strtolower($ext_from), Registry::get('config.forbidden_file_extensions')) || in_array(strtolower($ext_to), Registry::get('config.forbidden_file_extensions'))) {
		$action_type = 'error';
	...
	if (!in_array(strtolower(fn_get_file_ext($fname)), Registry::get('config.forbidden_file_extensions'))) {
