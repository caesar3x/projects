...
<tr>
	...
	<th width="10%"><a class="{$ajax_class}" href="{"`$c_url`&amp;sort_by=amount&amp;sort_order=`$sort_order`"|fn_url}" rev="pagination_contents">{$lang.points}</a>{if $sort_by == "amount"}{$sort_sign}{/if}</th>
