...
{if !$images.icon.is_flash && !$images.detailed.is_flash}
	...
	<a id="det_img_link_{$obj_id}" {if $detailed_image_path && $rel}rel="{$rel}"{/if} {if $rel}rev="{$rel}"{/if} class="{$link_class} {if !$detailed_image_path}default-cursor{/if} {if $detailed_image_path}cm-previewer{/if}" {if $detailed_image_path}href="{$detailed_image_path}" title="{$images.detailed.alt}"{/if}>
...
{else}
	...
	<a id="det_img_link_{$obj_id}" {if $rel}rel="{$rel}"{/if} {if $rel}rev="{$rel}"{/if} class="{$link_class}">
	
	<div id="{$obj_id}" {if $image_onclick}onmousedown="{$image_onclick}"{/if} class="{$link_class|default:"object-image"} option-changer" style="{if $image_width}width: {$image_width}px;{/if} {if $image_height}height: {$image_height}px;{/if}">
...
{if $show_detailed_link && $images.detailed_id && !$flash}
