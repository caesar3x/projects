...
<tr>
	...
	<th width="60%"><a class="{$ajax_class}{if $search.sort_by == "tag"} sort-link-{$search.sort_order}{/if}" href="{"`$c_url`&amp;sort_by=tag&amp;sort_order=`$search.sort_order`"|fn_url}" rev="pagination_contents">{$lang.tag}</a></th>
	<th><a class="{$ajax_class}{if $search.sort_by == "popularity"} sort-link-{$search.sort_order}{/if}" href="{"`$c_url`&amp;sort_by=popularity&amp;sort_order=`$search.sort_order`"|fn_url}" rev="pagination_contents">{$lang.popularity}</a></th>
	<th><a class="{$ajax_class}{if $search.sort_by == "users"} sort-link-{$search.sort_order}{/if}" href="{"`$c_url`&amp;sort_by=users&amp;sort_order=`$search.sort_order`"|fn_url}" rev="pagination_contents">{$lang.users}</a></th>
...
<div class="buttons-container">
	{include file="buttons/save_cancel.tpl" but_name="dispatch[tags.add]" create=true cancel_action="close"}
</div>
