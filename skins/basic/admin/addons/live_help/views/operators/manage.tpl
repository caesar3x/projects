...
<tr>
	...
	<th><a class="{$ajax_class}{if $sort_by == "operator_id"} sort-link-{$sort_order}{/if}" href="{"`$c_url`&amp;sort_by=operator_id&amp;sort_order=`$sort_order`"|fn_url}" rev="pagination_contents">{$lang.id}</a></th>
	<th><a class="{$ajax_class}{if $sort_by == "login"} sort-link-{$sort_order}{/if}" href="{"`$c_url`&amp;sort_by=login&amp;sort_order=`$sort_order`"|fn_url}" rev="pagination_contents">{$lang.username}</a></th>
	...
	<th><a class="{$ajax_class}{if $sort_by == "register_time"} sort-link-{$sort_order}{/if}" href="{"`$c_url`&amp;sort_by=register_time&amp;sort_order=`$sort_order`"|fn_url}" rev="pagination_contents">{$lang.registered}</a></th>
	<th width="15%"><a class="{$ajax_class}{if $sort_by == "status"} sort-link-{$sort_order}{/if}" href="{"`$c_url`&amp;sort_by=status&amp;sort_order=`$sort_order`"|fn_url}" rev="pagination_contents">{$lang.status}</a></th>
	<th>&nbsp;</th>
</tr>
