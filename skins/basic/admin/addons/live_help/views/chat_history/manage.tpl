...
<tr>
	<th><a class="{$ajax_class}{if $sort_by == "type"} sort-link-{$sort_order}{/if}" href="{"`$c_url`&amp;sort_by=type&amp;sort_order=`$sort_order`"|fn_url}" rev="pagination_contents">{$lang.group}</a></th>
	<th width="40%"><a class="{$ajax_class}{if $sort_by == "name"} sort-link-{$sort_order}{/if}" href="{"`$c_url`&amp;sort_by=name&amp;sort_order=`$sort_order`"|fn_url}" rev="pagination_contents">{$lang.name}</a></th>
	<th><a class="{$ajax_class}{if $sort_by == "operator_name"} sort-link-{$sort_order}{/if}" href="{"`$c_url`&amp;sort_by=operator_name&amp;sort_order=`$sort_order`"|fn_url}" rev="pagination_contents">{$lang.lh_operator}</a></th>
	<th><a class="{$ajax_class}{if $sort_by == "num"} sort-link-{$sort_order}{/if}" href="{"`$c_url`&amp;sort_by=num&amp;sort_order=`$sort_order`"|fn_url}" rev="pagination_contents">{$lang.messages}</a></th>
	<th><a class="{$ajax_class}{if $sort_by == "min_date"} sort-link-{$sort_order}{/if}" href="{"`$c_url`&amp;sort_by=min_date&amp;sort_order=`$sort_order`"|fn_url}" rev="pagination_contents">{$lang.lh_earliest}</a></th>
	<th><a class="{$ajax_class}{if $sort_by == "max_date"} sort-link-{$sort_order}{/if}" href="{"`$c_url`&amp;sort_by=max_date&amp;sort_order=`$sort_order`"|fn_url}" rev="pagination_contents">{$lang.lh_oldest}</a></th>
