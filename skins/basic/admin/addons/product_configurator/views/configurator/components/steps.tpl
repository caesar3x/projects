...
<tr>
	...
	<th width="80%"><a class="{$ajax_class}{if $steps_search.step_sort_by == "step_name"} sort-link-{$steps_search.step_sort_order}{/if}" href="{"`$c_url`&amp;step_sort_by=step_name&amp;step_sort_order=`$steps_search.step_sort_order`&amp;selected_section=steps"|fn_url}" rev="pagination_steps">{$lang.name}</a></th>
	<th width="15%"><a class="{$ajax_class}{if $steps_search.step_sort_by == "status"} sort-link-{$steps_search.step_sort_order}{/if}" href="{"`$c_url`&amp;step_sort_by=status&amp;step_sort_order=`$steps_search.step_sort_order`&amp;selected_section=steps"|fn_url}" rev="pagination_steps">{$lang.status}</a></th>
	<th>&nbsp;</th>
</tr>
...
<fieldset>
	<div class="form-field">
		...
		<input type="text" id="step_name" name="add_step_data[0][step_name]"  value="" class="input-text-large main-input" size="60" />
	</div>
