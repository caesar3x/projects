...
<tr>
	...
	<th width="80%"><a class="{$ajax_class}{if $groups_search.group_sort_by == "group_name"} sort-link-{$groups_search.group_sort_order}{/if}" href="{"`$c_url`&amp;group_sort_by=group_name&amp;group_sort_order=`$groups_search.group_sort_order`&amp;selected_section=groups"|fn_url}" rev="pagination_groups">{$lang.name}</a></th>
	...
	<th width="15%"><a class="{$ajax_class}{if $groups_search.group_sort_by == "status"} sort-link-{$groups_search.group_sort_order}{/if}" href="{"`$c_url`&amp;group_sort_by=status&amp;group_sort_order=`$groups_search.group_sort_order`&amp;selected_section=groups"|fn_url}" rev="pagination_groups">{$lang.status}</a></th>
	<th>&nbsp;</th>
</tr>
