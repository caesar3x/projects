...
<tr>
	...
	<th width="80%"><a class="{$ajax_class}{if $classes_search.class_sort_by == "class_name"} sort-link-{$classes_search.class_sort_order}{/if}" href="{"`$c_url`&amp;class_sort_by=class_name&amp;class_sort_order=`$classes_search.class_sort_order`&amp;selected_section=classes"|fn_url}" rev="pagination_classes">{$lang.name}</a></th>
	...
	<th width="15%"><a class="{$ajax_class}{if $classes_search.class_sort_by == "status"} sort-link-{$classes_search.class_sort_order}{/if}" href="{"`$c_url`&amp;class_sort_by=status&amp;class_sort_order=`$classes_search.class_sort_order`&amp;selected_section=classes"|fn_url}" rev="pagination_classes">{$lang.status}</a></th>
	<th>&nbsp;</th>
</tr>	
