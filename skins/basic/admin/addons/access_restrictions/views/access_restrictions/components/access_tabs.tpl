...
<tr>
	...
	<th width="55%"><a class="{$ajax_class}{if $sort_by == "reason"} sort-link-{$sort_order}{/if}" href="{$c_url}&amp;sort_by=reason&amp;sort_order={$sort_order}" rev="pagination_{$selected_section}">{$lang.reason}</a></th>
	...
	<th class="center" width="15%"><a class="{$ajax_class}{if $sort_by == "status"} sort-link-{$sort_order}{/if}" href="{$c_url}&amp;sort_by=status&amp;sort_order={$sort_order}" rev="pagination_{$selected_section}">{$lang.status}</a></th>
	<th width="5%">&nbsp;</th>
	{/hook}
</tr>
