...
<tr>
	...
	<th class="right" width="20%"><a class="{$ajax_class}{if $search.sort_by == "total"} sort-link-{$search.sort_order}{/if}" href="{"`$c_url`&amp;sort_by=total&amp;sort_order=`$search.sort_order`"|fn_url}" rev={$rev}>{$lang.total}</a></th>
	<th>&nbsp;</th>
</tr>
{if $incompleted_view}
