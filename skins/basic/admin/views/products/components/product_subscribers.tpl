...
<div class="buttons-container buttons-bg">
	...
	<div class="float-right">
		...
		{/capture}
		{include file="common_templates/popupbox.tpl" id="add_new_subscribers" text=$lang.add_new_subscribers content=$smarty.capture.new_email_picker link_text=$lang.add_subscriber act="general"}
	</div>
</div>
