...
<div class="buttons-container">
	<div class="float-right">
		{include file="common_templates/popupbox.tpl" id="add_new_block" action="block_manager.add" text=$lang.new_block content=$smarty.capture.add_new_block link_text=$lang.add_block act="general"}
		{include file="common_templates/popupbox.tpl" id="add_new_group" action="block_manager.add" text=$lang.new_group content=$smarty.capture.add_new_group link_text=$lang.add_group act="general"}
	</div>
</div>