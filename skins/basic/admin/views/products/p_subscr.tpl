...
<tr>
	...
	<th width="55%"><a class="{$ajax_class}{if $search.sort_by == "product"} sort-link-{$search.sort_order}{/if}" href="{"`$c_url`&amp;sort_by=product&amp;sort_order=`$search.sort_order`"|fn_url}" rev="pagination_contents">{$lang.name}</a></th>
	<th width="5%"><a class="{$ajax_class}{if $search.sort_by == "price"} sort-link-{$search.sort_order}{/if}" href="{"`$c_url`&amp;sort_by=price&amp;sort_order=`$search.sort_order`"|fn_url}" rev="pagination_contents">{$lang.price} ({$currencies.$primary_currency.symbol})</a></th>
	<th width="5%"><a class="{$ajax_class}{if $search.sort_by == "list_price"} sort-link-{$search.sort_order}{/if}" href="{"`$c_url`&amp;sort_by=list_price&amp;sort_order=`$search.sort_order`"|fn_url}" rev="pagination_contents">{$lang.list_price} ({$currencies.$primary_currency.symbol})</a></th>
	<th width="5%"><a class="{$ajax_class}{if $search.sort_by == "amount"} sort-link-{$search.sort_order}{/if}" href="{"`$c_url`&amp;sort_by=amount&amp;sort_order=`$search.sort_order`"|fn_url}" rev="pagination_contents">{$lang.quantity}</a></th>
	...
	<th width="15%"><a class="{$ajax_class}{if $search.sort_by == "num_subscr"} sort-link-{$search.sort_order}{/if}" href="{"`$c_url`&amp;sort_by=num_subscr&amp;sort_order=`$search.sort_order`"|fn_url}" rev="pagination_contents">{$lang.subscribers}</a></th>
	<th>&nbsp;</th>
</tr>
