...
{/capture}
{include file="common_templates/popupbox.tpl" id="add_payment" content=$smarty.capture.add_new_picker text=$lang.add_payout act="hidden"}
...
<tr>
	...
	<th><a class="{$ajax_class}{if $search.sort_by == "sort_vendor"} sort-link-{$search.sort_order}{/if}" href="{"`$c_url`&amp;sort_by=sort_vendor&amp;sort_order=`$search.sort_order`"|fn_url}" rev="pagination_contents">{$lang.vendor}</a></th>
	<th><a class="{$ajax_class}{if $search.sort_by == "sort_period"} sort-link-{$search.sort_order}{/if}" href="{"`$c_url`&amp;sort_by=sort_period&amp;sort_order=`$search.sort_order`"|fn_url}" rev="pagination_contents">{$lang.sales_period}</a></th>
	<th><a class="{$ajax_class}{if $search.sort_by == "sort_amount"} sort-link-{$search.sort_order}{/if}" href="{"`$c_url`&amp;sort_by=sort_amount&amp;sort_order=`$search.sort_order`"|fn_url}" rev="pagination_contents">{$lang.payment_amount}</a></th>
	<th><a class="{$ajax_class}{if $search.sort_by == "sort_date"} sort-link-{$search.sort_order}{/if}" href="{"`$c_url`&amp;sort_by=sort_date&amp;sort_order=`$search.sort_order`"|fn_url}" rev="pagination_contents">{$lang.date}</a></th>
...
{if !$hide_controls}
	...
	{capture name="tools"}
		{include file="common_templates/popupbox.tpl" id="add_payment" text=$lang.add_new_payout content="" link_text=$lang.new_payout act="general"}
	{/capture}	
