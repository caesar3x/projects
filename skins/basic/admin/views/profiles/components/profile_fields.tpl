...
<div class="select-field">
	...
	<p {if $ship_to_another}class="hidden"{/if} id="on_sta_notice">
		{$lang.text_ship_to_billing}.&nbsp;<a class="cm-combination dashed" onclick="$('#sa').switchAvailability(false); $('#elm_ship_to_another').click(); jQuery.profiles.rebuild_states('shipping');">{$lang.ship_to_another}</a>
	</p>
	<p {if !$ship_to_another}class="hidden"{/if} id="off_sta_notice">
		<a class="cm-combination dashed" onclick="$('#sa').switchAvailability(true); $('#elm_ship_to_another').click();">{$lang.text_ship_to_billing}</a>
	</p>
</div>
{elseif $section == "S"}
