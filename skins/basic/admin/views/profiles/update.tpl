...
{capture name="tabsbox"}
	...
	<form name="profile_form" action="{""|fn_url}" method="post" class="cm-form-highlight{if "COMPANY_ID"|defined &&  $user_data.user_id && $user_data.company_id != $smarty.const.COMPANY_ID} cm-hide-inputs{/if}">
	...
	{if !'COMPANY_ID'|defined || ('COMPANY_ID'|defined && ($user_data.user_type == 'A' || $smarty.request.user_type == 'A'))}
