...
<div id="bottom_menu">
	<div class="logo-bottom float-left" title="CS-Cart {if $smarty.const.PRODUCT_TYPE == "COMMUNITY"}Community Edition{/if}{if $smarty.const.PRODUCT_TYPE == "PROFESSIONAL"}Professional Edition{/if}{if $smarty.const.PRODUCT_TYPE == "MULTIVENDOR"}Multi-Vendor Edition{/if}">&nbsp;</div>
	{if "tools.store_mode"|fn_check_view_permissions && ($smarty.const.PRODUCT_TYPE != 'MULTISHOP' || $smarty.const.PRODUCT_TYPE == 'MULTISHOP' && "COMPANY_ID"|defined)}
