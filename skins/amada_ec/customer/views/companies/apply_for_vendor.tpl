...
<div id="apply_for_vendor_account" class="border"> {* content detailed *}
...
{if !$auth.user_id && $settings.Suppliers.create_vendor_administrator_account == "Y"}
	...
	{/if}
	<div class="form-field" id="company_description_admin_firstname">
	...
	<div class="form-field" id="company_description_admin_lastname">
