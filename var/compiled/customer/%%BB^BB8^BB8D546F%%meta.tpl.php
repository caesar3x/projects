...
smarty_core_load_plugins(array('plugins' => array(array('block', 'hook', 'meta.tpl', 3, false),array('modifier', 'lower', 'meta.tpl', 8, false),array('modifier', 'html_entity_decode', 'meta.tpl', 9, false),array('modifier', 'default', 'meta.tpl', 9, false),array('modifier', 'trim', 'meta.tpl', 12, false),array('function', 'set_id', 'meta.tpl', 12, false),)), $this); ?>
<?php ob_start(); ?>
...
<?php $this->_smarty_vars['capture']['template_content'] = ob_get_contents(); ob_end_clean(); ?><?php if (trim($this->_smarty_vars['capture']['template_content'])): ?><?php if ($this->_tpl_vars['auth']['area'] == 'A'): ?><span class="cm-template-box" template="meta.tpl" id="<?php echo smarty_function_set_id(array('name' => "meta.tpl"), $this);?>
