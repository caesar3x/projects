...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'floatval', 'common_templates/product_data.tpl', 1, false),array('modifier', 'default', 'common_templates/product_data.tpl', 9, false),array('modifier', 'fn_url', 'common_templates/product_data.tpl', 14, false),array('modifier', 'unescape', 'common_templates/product_data.tpl', 29, false),array('modifier', 'strip_tags', 'common_templates/product_data.tpl', 31, false),array('modifier', 'truncate', 'common_templates/product_data.tpl', 31, false),array('modifier', 'trim', 'common_templates/product_data.tpl', 70, false),array('modifier', 'escape', 'common_templates/product_data.tpl', 114, false),array('modifier', 'fn_get_product_features_list', 'common_templates/product_data.tpl', 147, false),array('modifier', 'strlen', 'common_templates/product_data.tpl', 161, false),array('modifier', 'replace', 'common_templates/product_data.tpl', 400, false),array('block', 'hook', 'common_templates/product_data.tpl', 55, false),array('function', 'set_id', 'common_templates/product_data.tpl', 443, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('sku','select_options','text_out_of_stock','notify_when_back_in_stock','enter_email','go','go','text_not_valid_email','error','more','old_price','list_price','price','enter_your_price','contact_us_for_price','sign_in_to_view_price','inc_tax','including_tax','you_save','you_save','in_stock','items','text_out_of_stock','in_stock','text_out_of_stock','quantity','text_cart_min_qty','text_edp_product'));
?>
<?php ob_start(); ?><?php if (( floatval($this->_tpl_vars['product']['price']) || $this->_tpl_vars['product']['zero_price_action'] == 'P' || $this->_tpl_vars['product']['zero_price_action'] == 'A' || ( ! floatval($this->_tpl_vars['product']['price']) && $this->_tpl_vars['product']['zero_price_action'] == 'R' ) ) && ! ( $this->_tpl_vars['settings']['General']['allow_anonymous_shopping'] == 'P' && ! $this->_tpl_vars['auth']['user_id'] )): ?>
...
" enctype="multipart/form-data" class="cm-disable-empty-files<?php if ($this->_tpl_vars['settings']['DHTML']['ajax_add_to_cart'] == 'Y' && ! $this->_tpl_vars['no_ajax']): ?> cm-ajax<?php endif; ?>">
...
unset($_smarty_tpl_vars);
 ?>
			...
			<?php if ($this->_tpl_vars['product']['avail_since'] > @TIME): ?>
				<?php $_smarty_tpl_vars = $this->_tpl_vars;$this->_smarty_include(array('smarty_include_tpl_file' => "common_templates/coming_soon_notice.tpl", 'smarty_include_vars' => array('avail_date' => $this->_tpl_vars['product']['avail_since'],'add_to_cart' => $this->_tpl_vars['product']['out_of_stock_actions'])));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
			<?php endif; ?>
...
').attr('disabled', this.checked ? '' : 'disabled');
							if (!this.checked) <?php echo $this->_tpl_vars['ldelim']; ?>
								...
								jQuery.ajaxRequest('<?php echo fn_url("products.product_notifications?enable=", 'C', 'rel', '&'); ?>
...
cache: false<?php echo $this->_tpl_vars['rdelim']; ?>
			...
			<?php if ($this->_tpl_vars['auth']['user_id'] == 0): ?>
			<div class="form-field" id="product_notify_email" style="padding: 0px;<?php if ($this->_tpl_vars['product_notification_enabled'] != 'Y'): ?> display: none;<?php endif; ?>">
...
<?php endif; ?>"
						class="input-text<?php if ($this->_tpl_vars['product_notification_email'] == ''): ?> cm-hint<?php endif; ?>" disabled="disabled" />
					<img title="<?php echo fn_get_lang_var('go', $this->getLanguage()); ?>
" class="go-button" alt="<?php echo fn_get_lang_var('go', $this->getLanguage()); ?>
" src="<?php echo $this->_tpl_vars['images_dir']; ?>
/icons/go.gif" onclick="if (jQuery.is.email($('#product_notify_email_<?php echo $this->_tpl_vars['obj_prefix']; ?>
<?php echo $this->_tpl_vars['obj_id']; ?>
').val()) && !jQuery.is.blank($('#product_notify_email_<?php echo $this->_tpl_vars['obj_prefix']; ?>
<?php echo $this->_tpl_vars['obj_id']; ?>
').val())) <?php echo $this->_tpl_vars['ldelim']; ?>
jQuery.processNotifications(); jQuery.ajaxRequest('<?php echo fn_url("products.product_notifications?enable=Y", 'C', 'rel', '&'); ?>
' + '&product_id=' + '<?php echo $this->_tpl_vars['product']['product_id']; ?>
' + '&email=' + $('#product_notify_email_<?php echo $this->_tpl_vars['obj_prefix']; ?>
<?php echo $this->_tpl_vars['obj_id']; ?>
').val(), <?php echo $this->_tpl_vars['ldelim']; ?>
method: 'get'<?php echo $this->_tpl_vars['rdelim']; ?>
, <?php echo $this->_tpl_vars['ldelim']; ?>
cache: false<?php echo $this->_tpl_vars['rdelim']; ?>
);<?php echo $this->_tpl_vars['rdelim']; ?>
else<?php echo $this->_tpl_vars['ldelim']; ?>
var data = [];data['back_in_stock'] = []; message = '<?php echo fn_get_lang_var('text_not_valid_email', $this->getLanguage()); ?>
'; data['back_in_stock']['message'] = message.replace('[email]', $('#product_notify_email_<?php echo $this->_tpl_vars['obj_prefix']; ?>
<?php echo $this->_tpl_vars['obj_id']; ?>
').val()); data['back_in_stock']['type'] = 'E'; data['back_in_stock']['title'] = '<?php echo fn_get_lang_var('error', $this->getLanguage()); ?>
'; jQuery.processNotifications(); jQuery.showNotifications(data);<?php echo $this->_tpl_vars['rdelim']; ?>
 return false;" />
			</div>
			<?php endif; ?>
...
<?php echo $this->_tpl_vars['obj_id']; ?>
">
			<?php $_smarty_tpl_vars = $this->_tpl_vars;$this->_smarty_include(array('smarty_include_tpl_file' => "views/companies/components/product_company_data.tpl", 'smarty_include_vars' => array('company_name' => $this->_tpl_vars['product']['company_name'],'company_id' => $this->_tpl_vars['product']['company_id'])));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
...
<?php echo $this->_tpl_vars['obj_id']; ?>
"><?php echo smarty_modifier_default(@$this->_tpl_vars['quantity_text'], fn_get_lang_var('quantity', $this->getLanguage())); ?>
:</label>
				<?php if ($this->_tpl_vars['product']['qty_content'] && $this->_tpl_vars['settings']['General']['inventory_tracking'] == 'Y'): ?>
...
/icons/up_arrow.gif" width="11" height="5" border="0" alt="&uarr;" /></a>
					<?php endif; ?>
...
/icons/down_arrow.gif" width="11" height="5" border="0" alt="&darr;" /></a>
				</div>
				<?php endif; ?>
				<?php endif; ?>
			</div>
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?><?php endif; ?><?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_hook($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?><?php $this->_smarty_vars['capture']['template_content'] = ob_get_contents(); ob_end_clean(); ?><?php if (trim($this->_smarty_vars['capture']['template_content'])): ?><?php if ($this->_tpl_vars['auth']['area'] == 'A'): ?><span class="cm-template-box" template="common_templates/product_data.tpl" id="<?php echo smarty_function_set_id(array('name' => "common_templates/product_data.tpl"), $this);?>
