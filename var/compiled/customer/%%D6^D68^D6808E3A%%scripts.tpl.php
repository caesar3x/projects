...
smarty_core_load_plugins(array('plugins' => array(array('function', 'script', 'common_templates/scripts.tpl', 1, false),array('function', 'set_id', 'common_templates/scripts.tpl', 114, false),array('modifier', 'escape', 'common_templates/scripts.tpl', 12, false),array('modifier', 'defined', 'common_templates/scripts.tpl', 77, false),array('modifier', 'fn_generate_security_hash', 'common_templates/scripts.tpl', 83, false),array('modifier', 'trim', 'common_templates/scripts.tpl', 114, false),array('block', 'hook', 'common_templates/scripts.tpl', 113, false),)), $this); ?>
<?php
...
?>
<?php ob_start(); ?><?php echo smarty_function_script(array('src' => "lib/js/jquery/jquery.min.js"), $this);?>
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?><?php endif; ?><?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_hook($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?><?php $this->_smarty_vars['capture']['template_content'] = ob_get_contents(); ob_end_clean(); ?><?php if (trim($this->_smarty_vars['capture']['template_content'])): ?><?php if ($this->_tpl_vars['auth']['area'] == 'A'): ?><span class="cm-template-box" template="common_templates/scripts.tpl" id="<?php echo smarty_function_set_id(array('name' => "common_templates/scripts.tpl"), $this);?>
