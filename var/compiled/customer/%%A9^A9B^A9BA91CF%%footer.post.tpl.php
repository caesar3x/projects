...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'fn_url', 'addons/statistics/hooks/index/footer.post.tpl', 6, false),array('modifier', 'escape', 'addons/statistics/hooks/index/footer.post.tpl', 28, false),array('modifier', 'trim', 'addons/statistics/hooks/index/footer.post.tpl', 30, false),array('function', 'set_id', 'addons/statistics/hooks/index/footer.post.tpl', 30, false),)), $this); ?>
<?php  ob_start();  ?><?php ob_start(); ?>
<script type="text/javascript">
//<![CDATA[
$(document).ready(function()<?php echo $this->_tpl_vars['ldelim']; ?>

	jQuery.ajaxRequest('<?php echo fn_url("statistics.collect", 'C', 'rel', '&'); ?>
