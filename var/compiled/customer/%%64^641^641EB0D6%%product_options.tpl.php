...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'views/products/components/product_options.tpl', 18, false),array('modifier', 'strpos', 'views/products/components/product_options.tpl', 30, false),array('modifier', 'floatval', 'views/products/components/product_options.tpl', 39, false),array('modifier', 'escape', 'views/products/components/product_options.tpl', 95, false),array('modifier', 'trim', 'views/products/components/product_options.tpl', 110, false),array('block', 'hook', 'views/products/components/product_options.tpl', 39, false),array('function', 'set_id', 'views/products/components/product_options.tpl', 142, false),)), $this); ?>
<?php
...
<?php if ($this->_tpl_vars['po']['description']): ?>&nbsp;<?php $_smarty_tpl_vars = $this->_tpl_vars;$this->_smarty_include(array('smarty_include_tpl_file' => "common_templates/tooltip.tpl", 'smarty_include_vars' => array('tooltip' => $this->_tpl_vars['po']['description'])));
...
<?php echo $this->_tpl_vars['id']; ?>
', '<?php echo $this->_tpl_vars['po']['option_id']; ?>
');<?php endif; ?>" <?php if ($this->_tpl_vars['product']['exclude_from_calculate'] && ! $this->_tpl_vars['product']['aoc'] || $this->_tpl_vars['po']['disabled']): ?>disabled="disabled" class="disabled"<?php endif; ?>>
...
');<?php endif; ?>" <?php if ($this->_tpl_vars['product']['exclude_from_calculate'] && ! $this->_tpl_vars['product']['aoc'] || $this->_tpl_vars['po']['disabled']): ?>disabled="disabled"<?php endif; ?> />
...
?>
					<?php if ($this->_tpl_vars['var']['image_pair']['image_id']): ?>
						...
						<?php $_smarty_tpl_vars = $this->_tpl_vars;$this->_smarty_include(array('smarty_include_tpl_file' => "common_templates/image.tpl", 'smarty_include_vars' => array('class' => "hand ".($this->_tpl_vars['_class'])." object-image",'show_thumbnail' => 'Y','images' => $this->_tpl_vars['var']['image_pair'],'object_type' => 'product_option','image_width' => '50','image_height' => '50','obj_id' => "variant_image_".($this->_tpl_vars['obj_prefix']).($this->_tpl_vars['id'])."_".($this->_tpl_vars['po']['option_id'])."_".($this->_tpl_vars['var']['variant_id']),'image_onclick' => "fn_set_option_value('".($this->_tpl_vars['obj_prefix']).($this->_tpl_vars['id'])."', '".($this->_tpl_vars['po']['option_id'])."', '".($this->_tpl_vars['var']['variant_id'])."'); void(0);")));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
					<?php endif; ?>
...
<?php endif; ?><?php $this->_smarty_vars['capture']['template_content'] = ob_get_contents(); ob_end_clean(); ?><?php if (trim($this->_smarty_vars['capture']['template_content'])): ?><?php if ($this->_tpl_vars['auth']['area'] == 'A'): ?><span class="cm-template-box" template="views/products/components/product_options.tpl" id="<?php echo smarty_function_set_id(array('name' => "views/products/components/product_options.tpl"), $this);?>
