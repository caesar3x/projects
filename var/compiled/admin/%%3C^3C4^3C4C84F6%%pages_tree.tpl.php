...
smarty_core_load_plugins(array('plugins' => array(array('function', 'math', 'views/pages/components/pages_tree.tpl', 48, false),array('modifier', 'default', 'views/pages/components/pages_tree.tpl', 48, false),array('modifier', 'fn_url', 'views/pages/components/pages_tree.tpl', 54, false),array('modifier', 'lower', 'views/pages/components/pages_tree.tpl', 76, false),array('modifier', 'is_array', 'views/pages/components/pages_tree.tpl', 80, false),array('modifier', 'yaml_unserialize', 'views/pages/components/pages_tree.tpl', 81, false),array('modifier', 'truncate', 'views/pages/components/pages_tree.tpl', 83, false),array('modifier', 'trim', 'views/pages/components/pages_tree.tpl', 145, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('check_uncheck_all','position_short','expand_collapse_list','expand_collapse_list','expand_collapse_list','expand_collapse_list','name','status','expand_sublist_of_items','expand_sublist_of_items','collapse_sublist_of_items','collapse_sublist_of_items','active','disabled','hidden','pending','new','active','disabled','hidden','pending','notify_customer','notify_orders_department','notify_vendor','notify_supplier','delete','no_data'));
?>
<?php if (! $this->_tpl_vars['checkbox_name']): ?><?php $this->assign('checkbox_name', 'page_ids', false); ?><?php endif; ?>

<?php if ($this->_tpl_vars['parent_id']): ?><div <?php if (! $this->_tpl_vars['expand_all']): ?>class="hidden"<?php endif; ?> id="page_<?php echo $this->_tpl_vars['parent_id']; ?>
"><?php endif; ?>
...
" id="on_page" class="hand cm-combinations-pages<?php if ($this->_tpl_vars['expand_all']): ?> hidden<?php endif; ?>" />
			<img src="<?php echo $this->_tpl_vars['images_dir']; ?>
/minus_plus.gif" width="13" height="12" border="0" alt="<?php echo fn_get_lang_var('expand_collapse_list', $this->getLanguage()); ?>
" title="<?php echo fn_get_lang_var('expand_collapse_list', $this->getLanguage()); ?>
" id="off_page" class="hand cm-combinations-pages<?php if (! $this->_tpl_vars['expand_all']): ?> hidden<?php endif; ?>" />
		</div>
		&nbsp;
		<?php endif; ?>
...
" class="input-text-short" /></td>
	<?php endif; ?>
	<td width="80%">
		<?php echo '<div class="float-left" '; ?><?php if (! $this->_tpl_vars['search']['paginate']): ?><?php echo 'style="padding-left: '; ?><?php echo smarty_function_math(array('equation' => "x*14",'x' => smarty_modifier_default(@$this->_tpl_vars['page']['level'], 0)), $this);?><?php echo 'px;"'; ?><?php endif; ?><?php echo '>'; ?><?php if ($this->_tpl_vars['page']['subpages'] || $this->_tpl_vars['page']['has_children']): ?><?php echo ''; ?><?php $this->assign('_dispatch', smarty_modifier_default(@$this->_tpl_vars['dispatch'], "pages.manage"), false); ?><?php echo ''; ?><?php if ($this->_tpl_vars['except_id']): ?><?php echo ''; ?><?php $this->assign('except_url', "&except_id=".($this->_tpl_vars['except_id']), false); ?><?php echo ''; ?><?php endif; ?><?php echo '<img src="'; ?><?php echo $this->_tpl_vars['images_dir']; ?><?php echo '/plus.gif" width="14" height="9" border="0" alt="'; ?><?php echo fn_get_lang_var('expand_sublist_of_items', $this->getLanguage()); ?><?php echo '" title="'; ?><?php echo fn_get_lang_var('expand_sublist_of_items', $this->getLanguage()); ?><?php echo '" id="on_page_'; ?><?php echo $this->_tpl_vars['page']['page_id']; ?><?php echo '" class="hand cm-combination-pages '; ?><?php if ($this->_tpl_vars['expand_all'] && ! $this->_tpl_vars['hide_show_all']): ?><?php echo 'hidden'; ?><?php endif; ?><?php echo '" '; ?><?php if ($this->_tpl_vars['page']['has_children']): ?><?php echo 'onclick="jQuery.ajaxRequest(\''; ?><?php echo fn_url(($this->_tpl_vars['_dispatch'])."?parent_id=".($this->_tpl_vars['page']['page_id'])."&get_tree=multi_level".($this->_tpl_vars['except_url'])."&display=".($this->_tpl_vars['display'])."&checkbox_name=".($this->_tpl_vars['checkbox_name']), 'A', 'rel', '&'); ?><?php echo '\', '; ?><?php echo $this->_tpl_vars['ldelim']; ?><?php echo 'result_ids: \'page_'; ?><?php echo $this->_tpl_vars['page']['page_id']; ?><?php echo '\', caching: true'; ?><?php echo $this->_tpl_vars['rdelim']; ?><?php echo ');"'; ?><?php endif; ?><?php echo ' /><img src="'; ?><?php echo $this->_tpl_vars['images_dir']; ?><?php echo '/minus.gif" width="14" height="9" border="0" alt="'; ?><?php echo fn_get_lang_var('collapse_sublist_of_items', $this->getLanguage()); ?><?php echo '" title="'; ?><?php echo fn_get_lang_var('collapse_sublist_of_items', $this->getLanguage()); ?><?php echo '" id="off_page_'; ?><?php echo $this->_tpl_vars['page']['page_id']; ?><?php echo '" class="hand cm-combination-pages '; ?><?php if (! $this->_tpl_vars['expand_all'] || $this->_tpl_vars['hide_show_all']): ?><?php echo 'hidden'; ?><?php endif; ?><?php echo '" />'; ?><?php elseif (! $this->_tpl_vars['search']['paginate']): ?><?php echo '<span style="padding-left: 14px;">&nbsp;</span>'; ?><?php endif; ?><?php echo ''; ?><?php if (! $this->_tpl_vars['picker']): ?><?php echo '<a href="'; ?><?php echo fn_url("pages.update?page_id=".($this->_tpl_vars['page']['page_id'])."&amp;come_from=".($this->_tpl_vars['come_from'])); ?><?php echo '" '; ?><?php if ($this->_tpl_vars['page']['status'] == 'N'): ?><?php echo 'class="manage-root-item-disabled"'; ?><?php endif; ?><?php echo ' id="page_title_'; ?><?php echo $this->_tpl_vars['page']['page_id']; ?><?php echo '">'; ?><?php else: ?><?php echo '<span id="page_title_'; ?><?php echo $this->_tpl_vars['page']['page_id']; ?><?php echo '">'; ?><?php endif; ?><?php echo ''; ?><?php echo $this->_tpl_vars['page']['page']; ?><?php echo ''; ?><?php if (! $this->_tpl_vars['picker']): ?><?php echo '</a>'; ?><?php else: ?><?php echo '</span>'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['page']['page_type']): ?><?php echo ''; ?><?php $this->assign('pt', $this->_tpl_vars['page_types'][$this->_tpl_vars['page']['page_type']], false); ?><?php echo '&nbsp;<span class="small-note lowercase">('; ?><?php echo fn_get_lang_var($this->_tpl_vars['pt']['single'], $this->getLanguage()); ?><?php echo ')</span>'; ?><?php endif; ?><?php echo '</div>'; ?>

	</td>
	<?php if (! $this->_tpl_vars['picker']): ?>
	<td width="15%">
		<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('id' => $this->_tpl_vars['page']['page_id'], 'status' => $this->_tpl_vars['page']['status'], 'hidden' => true, 'object_id_name' => 'page_id', 'table' => 'pages', )); ?><?php $this->assign('prefix', smarty_modifier_default(@$this->_tpl_vars['prefix'], 'select'), false); ?>
...
" />
		...
		<?php endif; ?>
		<li><a class="cm-confirm" href="<?php echo fn_url("pages.delete?page_type=".($this->_tpl_vars['page']['page_type'])."&amp;page_id=".($this->_tpl_vars['page']['page_id']).($this->_tpl_vars['multi_level'])); ?>
...
<?php if ($this->_tpl_vars['parent_id']): ?><!--page_<?php echo $this->_tpl_vars['parent_id']; ?>
--></div><?php endif; ?>