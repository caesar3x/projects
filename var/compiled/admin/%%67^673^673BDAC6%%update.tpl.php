...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'views/block_manager/update.tpl', 1, false),array('modifier', 'fn_url', 'views/block_manager/update.tpl', 4, false),array('modifier', 'fn_to_json', 'views/block_manager/update.tpl', 18, false),array('modifier', 'indent', 'views/block_manager/update.tpl', 89, false),array('modifier', 'lower', 'views/block_manager/update.tpl', 140, false),array('block', 'hook', 'views/block_manager/update.tpl', 146, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('general','name','block_content','list_objects','standard_sidebox','filling','group','appearance_type','block_order','horizontal','vertical','wrapper','block_width','tt_views_block_manager_update_block_width','percent','pixels'));
?>
...
_<?php echo $this->_tpl_vars['id']; ?>
<?php echo $this->_tpl_vars['block_type']; ?>
_'] = <?php echo fn_to_json($this->_tpl_vars['block']['properties']); ?>
;
...
<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('tooltip' => fn_get_lang_var('tt_views_block_manager_update_block_width', $this->getLanguage()), )); ?>
...
" class="input-text-short cm-value-integer" />
			<select name="block[width_unit]">
				<option value="P"<?php if ($this->_tpl_vars['block']['properties']['width_unit'] == 'P'): ?> selected="selected"<?php endif; ?>><?php echo smarty_modifier_lower(fn_get_lang_var('percent', $this->getLanguage())); ?>
</option>
