...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'fn_link_attach', 'common_templates/quick_menu.tpl', 1, false),array('modifier', 'escape', 'common_templates/quick_menu.tpl', 6, false),array('modifier', 'unescape', 'common_templates/quick_menu.tpl', 10, false),array('modifier', 'default', 'common_templates/quick_menu.tpl', 10, false),array('modifier', 'sizeof', 'common_templates/quick_menu.tpl', 96, false),array('modifier', 'lower', 'common_templates/quick_menu.tpl', 103, false),array('modifier', 'string_format', 'common_templates/quick_menu.tpl', 103, false),array('modifier', 'fn_url', 'common_templates/quick_menu.tpl', 112, false),)), $this); ?>
<?php
...
"><?php echo $this->_tpl_vars['subsect']['name']; ?>
		...
		<?php endif; ?>
		<p class="right">
			<a <?php if (! $this->_tpl_vars['expand_quick_menu']): ?>class="edit" onclick="jQuery.getScript(current_path + '/js/quick_menu.js');"<?php else: ?>class="edit cm-ajax" href="<?php echo fn_url("tools.show_quick_menu.edit"); ?>
