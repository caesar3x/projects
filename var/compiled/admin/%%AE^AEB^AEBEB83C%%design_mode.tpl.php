...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'fn_url', 'views/site_layout/design_mode.tpl', 8, false),array('modifier', 'defined', 'views/site_layout/design_mode.tpl', 10, false),array('modifier', 'default', 'views/site_layout/design_mode.tpl', 43, false),array('modifier', 'fn_check_view_permissions', 'views/site_layout/design_mode.tpl', 44, false),)), $this); ?>
<?php
...
" target="_blank"><?php echo fn_get_lang_var('view_storefront_translation_mode', $this->getLanguage()); ?>
		...
		<?php endif; ?>
		<p><?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_name' => $this->_tpl_vars['dispatch_val'], 'but_role' => 'button_main', 'but_text' => $this->_tpl_vars['mode_val'], )); ?>
