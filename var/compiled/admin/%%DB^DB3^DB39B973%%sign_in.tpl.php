<?php /* Smarty version 2.6.18, created on 2015-05-01 16:40:51
         compiled from buttons/sign_in.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'buttons/sign_in.tpl', 26, false),array('modifier', 'fn_check_view_permissions', 'buttons/sign_in.tpl', 27, false),array('modifier', 'fn_url', 'buttons/sign_in.tpl', 33, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('sign_in','remove_this_item','remove_this_item'));
?>
<?php  ob_start();  ?>
<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_text' => fn_get_lang_var('sign_in', $this->getLanguage()), 'but_onclick' => $this->_tpl_vars['but_onclick'], 'but_href' => $this->_tpl_vars['but_href'], 'but_arrow' => 'on', 'but_role' => $this->_tpl_vars['but_role'], )); ?>
