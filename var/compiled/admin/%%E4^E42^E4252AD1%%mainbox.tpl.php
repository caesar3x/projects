...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'fn_link_attach', 'common_templates/mainbox.tpl', 1, false),array('modifier', 'default', 'common_templates/mainbox.tpl', 17, false),array('modifier', 'sizeof', 'common_templates/mainbox.tpl', 29, false),array('modifier', 'lower', 'common_templates/mainbox.tpl', 40, false),array('modifier', 'string_format', 'common_templates/mainbox.tpl', 40, false),array('modifier', 'fn_url', 'common_templates/mainbox.tpl', 49, false),array('modifier', 'unescape', 'common_templates/mainbox.tpl', 49, false),array('modifier', 'trim', 'common_templates/mainbox.tpl', 67, false),array('modifier', 'fn_check_view_permissions', 'common_templates/mainbox.tpl', 97, false),)), $this); ?>
<?php
...
<div class="select-lang">
	<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('style' => 'graphic', 'link_tpl' => fn_link_attach($this->_tpl_vars['config']['current_url'], "descr_sl="), 'items' => $this->_tpl_vars['languages'], 'selected_id' => @DESCR_SL, 'key_name' => 'name', 'suffix' => 'content', 'display_icons' => true, )); ?>
...
?>
		<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_href' => $this->_tpl_vars['m']['href'], 'but_text' => fn_get_lang_var($this->_tpl_vars['title'], $this->getLanguage()), 'but_role' => 'tool', 'but_target' => $this->_tpl_vars['m']['target'], 'but_meta' => $this->_tpl_vars['m']['meta'], 'method' => 'GET', )); ?>
