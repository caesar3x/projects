...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'views/pages/update.tpl', 1, false),array('modifier', 'fn_get_usergroups', 'views/pages/update.tpl', 1, false),array('modifier', 'fn_url', 'views/pages/update.tpl', 5, false),array('modifier', 'fn_show_picker', 'views/pages/update.tpl', 18, false),array('modifier', 'fn_get_pages_plain_list', 'views/pages/update.tpl', 23, false),array('modifier', 'strpos', 'views/pages/update.tpl', 24, false),array('modifier', 'escape', 'views/pages/update.tpl', 25, false),array('modifier', 'indent', 'views/pages/update.tpl', 25, false),array('modifier', 'is_array', 'views/pages/update.tpl', 78, false),array('modifier', 'yaml_unserialize', 'views/pages/update.tpl', 79, false),array('modifier', 'lower', 'views/pages/update.tpl', 82, false),array('modifier', 'explode', 'views/pages/update.tpl', 132, false),array('modifier', 'fn_get_default_usergroups', 'views/pages/update.tpl', 137, false),array('modifier', 'in_array', 'views/pages/update.tpl', 139, false),array('modifier', 'count', 'views/pages/update.tpl', 139, false),array('modifier', 'defined', 'views/pages/update.tpl', 152, false),array('modifier', 'define', 'views/pages/update.tpl', 153, false),array('modifier', 'fn_parse_date', 'views/pages/update.tpl', 183, false),array('modifier', 'date_format', 'views/pages/update.tpl', 183, false),array('modifier', 'fn_explode_localizations', 'views/pages/update.tpl', 217, false),array('modifier', 'empty_tabs', 'views/pages/update.tpl', 411, false),array('modifier', 'cat', 'views/pages/update.tpl', 436, false),array('block', 'hook', 'views/pages/update.tpl', 135, false),array('function', 'math', 'views/pages/update.tpl', 199, false),array('function', 'script', 'views/pages/update.tpl', 414, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('information','parent_page','root_level','root_page','name','vendor','description','page_link','open_in_new_window','active','hidden','disabled','status','active','hidden','pending','disabled','seo_meta_data','page_title','meta_description','meta_keywords','availability','usergroups','creation_date','calendar','calendar','weekday_abr_0','weekday_abr_1','weekday_abr_2','weekday_abr_3','weekday_abr_4','weekday_abr_5','weekday_abr_6','month_name_abr_1','month_name_abr_2','month_name_abr_3','month_name_abr_4','month_name_abr_5','month_name_abr_6','month_name_abr_7','month_name_abr_8','month_name_abr_9','month_name_abr_10','month_name_abr_11','month_name_abr_12','localization','multiple_selectbox_notice','use_avail_period','avail_from','calendar','calendar','weekday_abr_0','weekday_abr_1','weekday_abr_2','weekday_abr_3','weekday_abr_4','weekday_abr_5','weekday_abr_6','month_name_abr_1','month_name_abr_2','month_name_abr_3','month_name_abr_4','month_name_abr_5','month_name_abr_6','month_name_abr_7','month_name_abr_8','month_name_abr_9','month_name_abr_10','month_name_abr_11','month_name_abr_12','avail_till','calendar','calendar','weekday_abr_0','weekday_abr_1','weekday_abr_2','weekday_abr_3','weekday_abr_4','weekday_abr_5','weekday_abr_6','month_name_abr_1','month_name_abr_2','month_name_abr_3','month_name_abr_4','month_name_abr_5','month_name_abr_6','month_name_abr_7','month_name_abr_8','month_name_abr_9','month_name_abr_10','month_name_abr_11','month_name_abr_12','poll_show_results','poll_header','poll_footer','poll_results','tt_addons_polls_hooks_pages_tabs_content_post_poll_results','preview','preview_as_admin'));
?>
<?php ob_start(); ?>
...
" method="post" name="page_update_form" class="cm-form-highlight">
<input type="hidden" id="selected_section" name="selected_section" value="<?php echo $this->_tpl_vars['selected_section']; ?>
" />
<input type="hidden" name="page_data[page_id]" value="<?php echo $this->_tpl_vars['page_data']['page_id']; ?>
" />
<input type="hidden" name="page_data[page_type]" id="page_type" size="55" value="<?php echo $this->_tpl_vars['page_type']; ?>
" class="input-text" />
<input type="hidden" name="come_from" value="<?php echo $this->_tpl_vars['come_from']; ?>
" />
...
:</label>
		<?php if (fn_show_picker('pages', @PAGE_THRESHOLD)): ?>
			<?php $_smarty_tpl_vars = $this->_tpl_vars;$this->_smarty_include(array('smarty_include_tpl_file' => "pickers/pages_picker.tpl", 'smarty_include_vars' => array('data_id' => 'location_page','input_name' => "page_data[parent_id]",'item_ids' => smarty_modifier_default(@$this->_tpl_vars['page_data']['parent_id'], '0'),'hide_link' => true,'hide_delete_button' => true,'show_root' => true,'default_name' => fn_get_lang_var('root_level', $this->getLanguage()),'display_input_id' => 'elm_parent_id','except_id' => $this->_tpl_vars['page_data']['page_id'])));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
		<?php else: ?>
...
?>
					<?php if (( strpos($this->_tpl_vars['page']['id_path'], ($this->_tpl_vars['page_data']['id_path'])."/") === false && $this->_tpl_vars['page_data']['page_id'] != $this->_tpl_vars['page']['page_id'] ) || $this->_tpl_vars['mode'] == 'add'): ?>
...
" class="input-text-large main-input" />
	...
	<?php $_smarty_tpl_vars = $this->_tpl_vars;$this->_smarty_include(array('smarty_include_tpl_file' => "views/companies/components/company_field.tpl", 'smarty_include_vars' => array('title' => fn_get_lang_var('vendor', $this->getLanguage()),'name' => "page_data[company_id]",'id' => 'page_data_company_id','selected' => $this->_tpl_vars['page_data']['company_id'])));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
...
<?php if (isset($__parent_tpl_vars)) { $this->_tpl_vars = $__parent_tpl_vars; unset($__parent_tpl_vars);} ?>
	...
	<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('input_name' => "page_data[status]", 'id' => 'page_data', 'obj' => $this->_tpl_vars['page_data'], 'hidden' => true, )); ?>
...
<?php if ($this->_tpl_vars['mode'] != 'add'): ?>
	<div id="content_blocks">
		<?php $_smarty_tpl_vars = $this->_tpl_vars;$this->_smarty_include(array('smarty_include_tpl_file' => "views/block_manager/components/select_blocks.tpl", 'smarty_include_vars' => array('object_id' => $this->_tpl_vars['page_data']['page_id'],'data_name' => 'page_data','section' => 'pages')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
	</div>
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?><?php endif; ?><?php if ($this->_tpl_vars['addons']['polls']['status'] == 'A'): ?><?php $__parent_tpl_vars = $this->_tpl_vars; ?>
...
:</label>
			...
			<input type="checkbox" class="checkbox" name="page_data[poll_data][show_results]" id="poll_show_results" value="Y"<?php if ($this->_tpl_vars['page_data']['poll']['show_results'] == 'Y'): ?> checked="checked"<?php endif; ?> />
		</div>
...
<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('tooltip' => fn_get_lang_var('tt_addons_polls_hooks_pages_tabs_content_post_poll_results', $this->getLanguage()), )); ?>

<?php if ($this->_tpl_vars['tooltip']): ?> (<a class="cm-tooltip<?php if ($this->_tpl_vars['params']): ?> <?php echo $this->_tpl_vars['params']; ?>
<?php endif; ?>" title="<?php echo $this->_tpl_vars['tooltip']; ?>
...
<div class="buttons-container cm-toggle-button buttons-bg">
	<?php if ($this->_tpl_vars['mode'] == 'add'): ?>
		<?php $_smarty_tpl_vars = $this->_tpl_vars;$this->_smarty_include(array('smarty_include_tpl_file' => "buttons/save_cancel.tpl", 'smarty_include_vars' => array('but_name' => "dispatch[pages.add]")));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
	<?php else: ?>
		<?php $_smarty_tpl_vars = $this->_tpl_vars;$this->_smarty_include(array('smarty_include_tpl_file' => "buttons/save_cancel.tpl", 'smarty_include_vars' => array('but_name' => "dispatch[pages.update]")));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
	<?php endif; ?>
...
<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('content' => $this->_smarty_vars['capture']['tabsbox'], 'track' => true, )); ?>
...
<?php else: ?>
	...
	<?php if ($this->_tpl_vars['page_type'] != @PAGE_TYPE_LINK): ?>
		<?php ob_start(); ?>
			<?php $this->assign('view_uri', "pages.view?page_id=".($this->_tpl_vars['page_data']['page_id']), false); ?>
