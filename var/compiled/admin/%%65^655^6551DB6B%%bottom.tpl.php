<?php /* Smarty version 2.6.18, created on 2015-04-30 22:03:58
         compiled from bottom.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'fn_link_attach', 'bottom.tpl', 1, false),array('modifier', 'defined', 'bottom.tpl', 1, false),array('modifier', 'fn_check_view_permissions', 'bottom.tpl', 9, false),array('modifier', 'fn_url', 'bottom.tpl', 12, false),array('modifier', 'sizeof', 'bottom.tpl', 27, false),array('modifier', 'default', 'bottom.tpl', 32, false),array('modifier', 'lower', 'bottom.tpl', 37, false),array('modifier', 'string_format', 'bottom.tpl', 37, false),array('modifier', 'unescape', 'bottom.tpl', 46, false),array('modifier', 'truncate', 'bottom.tpl', 113, false),array('modifier', 'fn_check_meta_redirect', 'bottom.tpl', 127, false),array('block', 'hook', 'bottom.tpl', 101, false),)), $this); ?>
<?php
...
?>
<?php  ob_start();  ?><?php if (defined('DEBUG_MODE')): ?>
...
<div id="bottom_menu">
	<div class="logo-bottom float-left" title="CS-Cart <?php if (@PRODUCT_TYPE == 'COMMUNITY'): ?>Community Edition<?php endif; ?><?php if (@PRODUCT_TYPE == 'PROFESSIONAL'): ?>Professional Edition<?php endif; ?><?php if (@PRODUCT_TYPE == 'MULTIVENDOR'): ?>Multi-Vendor Edition<?php endif; ?>">&nbsp;</div>
	<?php if (fn_check_view_permissions("tools.store_mode") && ( @PRODUCT_TYPE != 'MULTISHOP' || @PRODUCT_TYPE == 'MULTISHOP' && defined('COMPANY_ID') )): ?>
...
"><?php echo fn_get_lang_var('dev_store', $this->getLanguage()); ?>
	...
	<?php if ($this->_tpl_vars['auth']['user_id']): ?>
		<div class="float-left">
			...
			<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('style' => 'graphic', 'link_tpl' => fn_link_attach($this->_tpl_vars['config']['current_url'], "sl="), 'items' => $this->_tpl_vars['languages'], 'selected_id' => @CART_LANGUAGE, 'display_icons' => true, 'key_name' => 'name', 'language_var_name' => 'sl', 'class' => 'languages', )); ?>
...
<?php $this->assign('icon_tpl', ($this->_tpl_vars['images_dir'])."/flags/%s.png", false); ?>

<?php if ($this->_tpl_vars['style'] == 'graphic'): ?>
	<?php if ($this->_tpl_vars['display_icons'] == true): ?>
		<img src="<?php echo smarty_modifier_string_format(smarty_modifier_lower($this->_tpl_vars['selected_id']), $this->_tpl_vars['icon_tpl']); ?>
" width="16" height="16" border="0" alt="" onclick="$('#sw_select_<?php echo $this->_tpl_vars['selected_id']; ?>
...
" <?php if ($this->_tpl_vars['display_icons'] == true): ?>style="background-image: url('<?php echo smarty_modifier_string_format(smarty_modifier_lower($this->_tpl_vars['id']), $this->_tpl_vars['icon_tpl']); ?>
');"<?php endif; ?>><?php echo $this->_tpl_vars['item'][$this->_tpl_vars['key_name']]; ?>
...
<?php if (isset($__parent_tpl_vars)) { $this->_tpl_vars = $__parent_tpl_vars; unset($__parent_tpl_vars);} ?>
			...
			<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('style' => 'graphic', 'link_tpl' => fn_link_attach($this->_tpl_vars['config']['current_url'], "currency="), 'items' => $this->_tpl_vars['currencies'], 'selected_id' => $this->_tpl_vars['secondary_currency'], 'display_icons' => false, 'key_name' => 'description', )); ?>
...
<?php if (isset($__parent_tpl_vars)) { $this->_tpl_vars = $__parent_tpl_vars; unset($__parent_tpl_vars);} ?>
	...
	<?php if (! defined('COMPANY_ID')): ?>
		<div class="float-left">
			<?php $this->_tag_stack[] = array('hook', array('name' => "index:top")); $_block_repeat=true;smarty_block_hook($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php if ($this->_tpl_vars['addons']['statistics']['status'] == 'A'): ?><?php $__parent_tpl_vars = $this->_tpl_vars; ?>

			<a href="<?php echo fn_url("statistics.visitors?report=online&amp;section=general"); ?>
