...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'buttons/sign_out.tpl', 26, false),array('modifier', 'fn_check_view_permissions', 'buttons/sign_out.tpl', 27, false),array('modifier', 'fn_url', 'buttons/sign_out.tpl', 33, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('remove_this_item','remove_this_item'));
?>
<?php  ob_start();  ?>
<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_text' => '&nbsp;', 'but_onclick' => $this->_tpl_vars['but_onclick'], 'but_href' => $this->_tpl_vars['but_href'], 'but_role' => $this->_tpl_vars['but_role'], )); ?>
