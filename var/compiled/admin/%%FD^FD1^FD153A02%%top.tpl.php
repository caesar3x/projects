...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'substr', 'top.tpl', 4, false),array('modifier', 'fn_strlen', 'top.tpl', 5, false),array('modifier', 'fn_url', 'top.tpl', 10, false),array('modifier', 'defined', 'top.tpl', 35, false),array('modifier', 'sizeof', 'top.tpl', 58, false),array('modifier', 'fn_substr', 'top.tpl', 90, false),array('block', 'hook', 'top.tpl', 146, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('view_storefront','search','loading','vendor','dashboard','search_tooltip'));
?>
<div class="header-wrap">
<div id="header">
	<div id="logo">
		<?php $this->assign('name', substr($this->_tpl_vars['settings']['Company']['company_name'], 0, 40), false); ?>
		<?php if (fn_strlen($this->_tpl_vars['settings']['Company']['company_name']) > 40): ?>
...
</a><a href="<?php echo fn_url($this->_tpl_vars['config']['http_location']); ?>
...
<?php if (@PRODUCT_TYPE == 'MULTIVENDOR' || @PRODUCT_TYPE == 'MULTISHOP'): ?>
	...
	<?php if (sizeof($this->_tpl_vars['s_companies']) > 1): ?>
		...
		<?php else: ?>
			...
			<?php endif; ?>
		<?php endif; ?>
		<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('data_url' => "companies.get_companies_list?show_all=Y&action=href", 'text' => $this->_tpl_vars['company_name'], 'id' => 'top_company_id', )); ?><div class="tools-container inline" <?php if ($this->_tpl_vars['elements_switcher_id']): ?> id="<?php echo $this->_tpl_vars['elements_switcher_id']; ?>
...
"><?php echo fn_get_lang_var($this->_tpl_vars['subitem_title'], $this->getLanguage()); ?>
		...
		<?php endif; ?>
		<li class="search">
			<?php $this->_tag_stack[] = array('hook', array('name' => "index:global_search")); $_block_repeat=true;smarty_block_hook($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
...
">
					...
					<div>
						...
						<label for="gs_text"><a><input type="text" class="cm-tooltip" id="gs_text" name="q" autocomplete="off" title="<?php echo fn_get_lang_var('search_tooltip', $this->getLanguage()); ?>
" /></a></label>
					</div>
				</form>
