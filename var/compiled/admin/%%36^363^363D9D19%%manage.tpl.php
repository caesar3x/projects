<?php /* Smarty version 2.6.18, created on 2015-04-30 22:04:38
         compiled from views/pages/manage.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'fn_url', 'views/pages/manage.tpl', 6, false),array('modifier', 'default', 'views/pages/manage.tpl', 17, false),array('modifier', 'fn_check_view_permissions', 'views/pages/manage.tpl', 31, false),array('modifier', 'substr_count', 'views/pages/manage.tpl', 35, false),array('modifier', 'replace', 'views/pages/manage.tpl', 36, false),array('modifier', 'defined', 'views/pages/manage.tpl', 48, false),)), $this); ?>
<?php
...
<div class="items-container multi-level">
	<?php $_smarty_tpl_vars = $this->_tpl_vars;$this->_smarty_include(array('smarty_include_tpl_file' => "views/pages/components/pages_tree.tpl", 'smarty_include_vars' => array('header' => true)));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
</div>
...
unset($_smarty_tpl_vars);
 ?>
		<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('prefix' => "main".($this->_tpl_vars['_REQUEST']['content_id']), 'hide_actions' => true, 'tools_list' => $this->_smarty_vars['capture']['tools_list'], 'display' => 'inline', 'link_text' => fn_get_lang_var('choose_action', $this->getLanguage()), )); ?>
...
?>
	<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('tool_href' => "pages.add?page_type=".($this->_tpl_vars['_k'])."&come_from=".($this->_tpl_vars['come_from']), 'prefix' => 'top', 'link_text' => fn_get_lang_var($this->_tpl_vars['_p']['add_name'], $this->getLanguage()), 'hide_tools' => true, )); ?>
...
<?php ob_start(); ?>
	<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_text' => fn_get_lang_var('tree', $this->getLanguage()), 'but_href' => "pages.manage?get_tree=multi_level", 'but_role' => 'tool', )); ?>
...
?>
	<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_text' => fn_get_lang_var($this->_tpl_vars['_p']['name'], $this->getLanguage()), 'but_href' => "pages.manage?page_type=".($this->_tpl_vars['_k']), 'but_role' => 'tool', )); ?>
