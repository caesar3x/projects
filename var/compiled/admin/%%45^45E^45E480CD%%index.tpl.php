<?php /* Smarty version 2.6.18, created on 2015-04-30 22:03:57
         compiled from index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'defined', 'index.tpl', 29, false),array('modifier', 'escape', 'index.tpl', 55, false),array('modifier', 'fn_generate_security_hash', 'index.tpl', 123, false),array('modifier', 'fn_query_remove', 'index.tpl', 168, false),array('modifier', 'strpos', 'index.tpl', 169, false),array('modifier', 'fn_link_attach', 'index.tpl', 179, false),array('modifier', 'fn_get_notifications', 'index.tpl', 206, false),array('modifier', 'lower', 'index.tpl', 208, false),array('modifier', 'default', 'index.tpl', 241, false),array('modifier', 'unescape', 'index.tpl', 241, false),array('block', 'hook', 'index.tpl', 37, false),array('function', 'join_css', 'index.tpl', 40, false),array('function', 'script', 'index.tpl', 42, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('admin_panel','cannot_buy','no_products_selected','error_no_items_selected','delete_confirmation','text_out_of_stock','items','text_required_group_product','save','close','loading','notice','warning','error','text_are_you_sure_to_proceed','text_invalid_url','error_validator_email','error_validator_confirm_email','error_validator_phone','error_validator_integer','error_validator_multiple','error_validator_password','error_validator_required','error_validator_zipcode','error_validator_message','text_page_loading','error_ajax','text_changes_not_saved','text_data_changed','text_block_trial_notice','text_expired_license','file_browser','loading','close','close','processing'));
?>
...
<?php $__parent_tpl_vars = $this->_tpl_vars; ?><?php echo smarty_function_script(array('src' => "lib/js/jquery/jquery.min.js"), $this);?>
...
<?php if ($this->_tpl_vars['addons']['news_and_emails']['status'] == 'A'): ?><?php $__parent_tpl_vars = $this->_tpl_vars; ?>
...
</script><?php if (isset($__parent_tpl_vars)) { $this->_tpl_vars = $__parent_tpl_vars; unset($__parent_tpl_vars);} ?><?php endif; ?><?php if ($this->_tpl_vars['addons']['banners']['status'] == 'A'): ?><?php $__parent_tpl_vars = $this->_tpl_vars; ?>
...
</script><?php if (isset($__parent_tpl_vars)) { $this->_tpl_vars = $__parent_tpl_vars; unset($__parent_tpl_vars);} ?><?php endif; ?><?php if ($this->_tpl_vars['addons']['recurring_billing']['status'] == 'A'): ?><?php $__parent_tpl_vars = $this->_tpl_vars; ?>
...
<?php $this->assign('c_url', fn_query_remove($this->_tpl_vars['config']['current_url'], 'demo_skin'), false); ?>
...
<tr>
	...
	<td class="right"><?php echo fn_get_lang_var($this->_tpl_vars['l'], $this->getLanguage()); ?>
:</td>
	<td>
		<select name="demo_skin[<?php echo $this->_tpl_vars['area']; ?>
]" onchange="jQuery.redirect('<?php echo fn_link_attach($this->_tpl_vars['c_url'], "demo_skin[".($this->_tpl_vars['area'])."]="); ?>
' + this.value);">
...
<div id="comet_container" title="<?php echo fn_get_lang_var('processing', $this->getLanguage()); ?>
..."></div><?php if (isset($__parent_tpl_vars)) { $this->_tpl_vars = $__parent_tpl_vars; unset($__parent_tpl_vars);} ?>
