...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'fn_url', 'views/pages/components/pages_search_form.tpl', 5, false),array('modifier', 'fn_show_picker', 'views/pages/components/pages_search_form.tpl', 49, false),array('modifier', 'fn_get_pages_plain_list', 'views/pages/components/pages_search_form.tpl', 54, false),array('modifier', 'escape', 'views/pages/components/pages_search_form.tpl', 55, false),array('modifier', 'indent', 'views/pages/components/pages_search_form.tpl', 55, false),array('block', 'hook', 'views/pages/components/pages_search_form.tpl', 89, false),array('function', 'math', 'views/pages/components/pages_search_form.tpl', 116, false),)), $this); ?>
<?php
...
" class="search-input-text" />
			<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('search' => 'Y', 'but_name' => ($this->_tpl_vars['dispatch']), )); ?>
...
<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('section_content' => $this->_smarty_vars['capture']['section'], )); ?>
