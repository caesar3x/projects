...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'defined', 'common_templates/attach_images.tpl', 12, false),array('modifier', 'define', 'common_templates/attach_images.tpl', 13, false),array('modifier', 'explode', 'common_templates/attach_images.tpl', 36, false),array('modifier', 'default', 'common_templates/attach_images.tpl', 37, false),array('modifier', 'fn_url', 'common_templates/attach_images.tpl', 57, false),array('modifier', 'fn_generate_thumbnail', 'common_templates/attach_images.tpl', 89, false),array('modifier', 'cat', 'common_templates/attach_images.tpl', 117, false),array('modifier', 'md5', 'common_templates/attach_images.tpl', 117, false),array('modifier', 'escape', 'common_templates/attach_images.tpl', 129, false),array('modifier', 'count', 'common_templates/attach_images.tpl', 151, false),array('block', 'hook', 'common_templates/attach_images.tpl', 53, false),array('function', 'math', 'common_templates/attach_images.tpl', 83, false),array('function', 'script', 'common_templates/attach_images.tpl', 114, false),)), $this); ?>
<?php
...
" class="cm-confirm cm-ajax delete" name="delete_image"><?php echo fn_get_lang_var('delete_image', $this->getLanguage()); ?>
		...
		<div class="float-left attach-images-alt">
			<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('var_name' => ($this->_tpl_vars['name'])."_image_icon".($this->_tpl_vars['suffix'])."[".($this->_tpl_vars['key'])."]", 'image' => true, )); ?>
...
" />
			<?php $this->_tag_stack[] = array('hook', array('name' => "attach_images:options_for_icon")); $_block_repeat=true;smarty_block_hook($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
			<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_hook($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
			<?php endif; ?>
		</div>
	</div>
...
" class="cm-confirm cm-ajax delete" name="delete_image"><?php echo fn_get_lang_var('delete_image', $this->getLanguage()); ?>
		...
		<div class="float-left attach-images-alt">
			<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('var_name' => ($this->_tpl_vars['name'])."_image_detailed".($this->_tpl_vars['suffix'])."[".($this->_tpl_vars['key'])."]", )); ?>
