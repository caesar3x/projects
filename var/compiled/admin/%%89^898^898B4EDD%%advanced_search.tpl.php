...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'fn_crc32', 'common_templates/advanced_search.tpl', 3, false),array('modifier', 'string_format', 'common_templates/advanced_search.tpl', 3, false),array('modifier', 'fn_get_views', 'common_templates/advanced_search.tpl', 13, false),array('modifier', 'strpos', 'common_templates/advanced_search.tpl', 22, false),array('modifier', 'escape', 'common_templates/advanced_search.tpl', 25, false),array('modifier', 'default', 'common_templates/advanced_search.tpl', 50, false),array('modifier', 'fn_check_view_permissions', 'common_templates/advanced_search.tpl', 51, false),array('modifier', 'fn_url', 'common_templates/advanced_search.tpl', 57, false),array('modifier', 'count', 'common_templates/advanced_search.tpl', 87, false),array('modifier', 'fn_query_remove', 'common_templates/advanced_search.tpl', 105, false),array('function', 'split', 'common_templates/advanced_search.tpl', 80, false),)), $this); ?>
<?php
...
<?php endif; ?>" class="input-save-name <?php if (! $this->_tpl_vars['search']['view_id'] && ! $this->_tpl_vars['views'][$this->_tpl_vars['search']['view_id']]): ?>cm-hint<?php endif; ?>" />
			<span class="submit-button">
				<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_text' => fn_get_lang_var('save', $this->getLanguage()), 'but_onclick' => "fn_check_views('view_name', 'views')", 'but_role' => 'button', )); ?>
...
" class="hand valign" /></a>
				...
				<?php if (count($this->_tpl_vars['views']) <= 10): ?>
						<li class="last right">
							<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_text' => fn_get_lang_var('new_saved_search', $this->getLanguage()), 'but_role' => 'text', 'but_onclick' => "fn_advanced_search_open('".($this->_tpl_vars['a_id'])."');", 'but_meta' => "text-button", )); ?>
