...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'common_templates/object_group.tpl', 1, false),array('modifier', 'fn_url', 'common_templates/object_group.tpl', 9, false),array('modifier', 'lower', 'common_templates/object_group.tpl', 38, false),array('modifier', 'is_array', 'common_templates/object_group.tpl', 42, false),array('modifier', 'yaml_unserialize', 'common_templates/object_group.tpl', 43, false),array('modifier', 'truncate', 'common_templates/object_group.tpl', 45, false),array('modifier', 'trim', 'common_templates/object_group.tpl', 107, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('delete','delete','edit','edit','active','disabled','hidden','pending','new','active','disabled','hidden','pending','notify_customer','notify_orders_department','notify_vendor','notify_supplier'));
?>
...
<?php if (! $this->_tpl_vars['no_table']): ?>
	...
	<div class="float-right">
		<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('id' => $this->_tpl_vars['id'], 'status' => $this->_tpl_vars['status'], 'hidden' => $this->_tpl_vars['hidden'], 'object_id_name' => $this->_tpl_vars['object_id_name'], 'table' => $this->_tpl_vars['table'], 'hide_for_vendor' => $this->_tpl_vars['hide_for_vendor'], )); ?><?php $this->assign('prefix', smarty_modifier_default(@$this->_tpl_vars['prefix'], 'select'), false); ?>
