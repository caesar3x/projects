<?php /* Smarty version 2.6.18, created on 2015-05-01 18:17:11
         compiled from pickers/products_picker.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'fn_get_product_name', 'pickers/products_picker.tpl', 1, false),array('modifier', 'default', 'pickers/products_picker.tpl', 1, false),array('modifier', 'count', 'pickers/products_picker.tpl', 1, false),array('modifier', 'fn_get_selected_product_options_info', 'pickers/products_picker.tpl', 1, false),array('modifier', 'fn_url', 'pickers/products_picker.tpl', 1, false),array('modifier', 'is_array', 'pickers/products_picker.tpl', 9, false),array('modifier', 'explode', 'pickers/products_picker.tpl', 10, false),array('modifier', 'implode', 'pickers/products_picker.tpl', 21, false),array('modifier', 'fn_get_product_options', 'pickers/products_picker.tpl', 66, false),array('modifier', 'escape', 'pickers/products_picker.tpl', 102, false),array('modifier', 'fn_check_view_permissions', 'pickers/products_picker.tpl', 129, false),array('function', 'math', 'pickers/products_picker.tpl', 3, false),array('function', 'script', 'pickers/products_picker.tpl', 7, false),array('block', 'hook', 'pickers/products_picker.tpl', 57, false),)), $this); ?>
<?php
...
<?php if ($this->_tpl_vars['view_mode'] != 'list'): ?>
	<div class="hidden">
		...
		<?php if (! $this->_tpl_vars['no_container']): ?><div class="buttons-container"><?php endif; ?><?php if ($this->_tpl_vars['picker_view']): ?>[<?php endif; ?>
			<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_id' => "opener_picker_".($this->_tpl_vars['data_id']), 'but_href' => fn_url("products.picker?display=".($this->_tpl_vars['display'])."&amp;company_id=".($this->_tpl_vars['company_id'])."&amp;picker_for=".($this->_tpl_vars['picker_for'])."&amp;extra=".($this->_tpl_vars['extra_var'])."&amp;checkbox_name=".($this->_tpl_vars['checkbox_name'])."&amp;aoc=".($this->_tpl_vars['aoc'])."&amp;data_id=".($this->_tpl_vars['data_id'])), 'but_text' => smarty_modifier_default(@$this->_tpl_vars['but_text'], fn_get_lang_var('add_products', $this->getLanguage())), 'but_role' => 'add', 'but_rev' => "content_".($this->_tpl_vars['data_id']), 'but_meta' => "cm-dialog-opener", )); ?>
