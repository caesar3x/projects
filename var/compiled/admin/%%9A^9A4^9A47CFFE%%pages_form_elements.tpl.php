...
smarty_core_load_plugins(array('plugins' => array(array('block', 'hook', 'addons/form_builder/views/pages/components/pages_form_elements.tpl', 73, false),array('modifier', 'strstr', 'addons/form_builder/views/pages/components/pages_form_elements.tpl', 88, false),array('modifier', 'default', 'addons/form_builder/views/pages/components/pages_form_elements.tpl', 90, false),array('modifier', 'lower', 'addons/form_builder/views/pages/components/pages_form_elements.tpl', 93, false),array('modifier', 'is_array', 'addons/form_builder/views/pages/components/pages_form_elements.tpl', 97, false),array('modifier', 'yaml_unserialize', 'addons/form_builder/views/pages/components/pages_form_elements.tpl', 98, false),array('modifier', 'truncate', 'addons/form_builder/views/pages/components/pages_form_elements.tpl', 100, false),array('modifier', 'fn_url', 'addons/form_builder/views/pages/components/pages_form_elements.tpl', 126, false),array('modifier', 'trim', 'addons/form_builder/views/pages/components/pages_form_elements.tpl', 162, false),array('modifier', 'substr_count', 'addons/form_builder/views/pages/components/pages_form_elements.tpl', 219, false),array('function', 'math', 'addons/form_builder/views/pages/components/pages_form_elements.tpl', 237, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('position_short','name','type','required','status','base','selectbox','radiogroup','multiple_checkboxes','multiple_selectbox','checkbox','input_field','textarea','header','separator','special','date','email','number','phone','countries_list','states_list','file','referer','ip_address','active','disabled','hidden','pending','new','active','disabled','hidden','pending','notify_customer','notify_orders_department','notify_vendor','notify_supplier','position_short','name','base','selectbox','radiogroup','multiple_checkboxes','multiple_selectbox','checkbox','input_field','textarea','header','separator','special','date','email','number','phone','countries_list','states_list','file','referer','ip_address','active','hidden','disabled','status','active','hidden','pending','disabled','position_short','description'));
?>
<?php echo '
...
" width="100%" <?php if ($this->_tpl_vars['element']['element_type'] != @FORM_SEPARATOR): ?>class="hidden"<?php endif; ?> /></td>
	<td>
		<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('element_type' => $this->_tpl_vars['element']['element_type'], 'elm_id' => $this->_tpl_vars['element']['element_id'], )); ?>

<select id="elm_<?php echo $this->_tpl_vars['elm_id']; ?>
...
" type="checkbox" <?php if (strstr('HD', $this->_tpl_vars['element']['element_type'])): ?>disabled="disabled"<?php endif; ?> name="page_data[form][elements_data][<?php echo $this->_tpl_vars['num']; ?>
	...
	<td>
		<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('id' => $this->_tpl_vars['element']['element_id'], 'prefix' => 'elm', 'status' => $this->_tpl_vars['element']['status'], 'hidden' => "", 'object_id_name' => 'element_id', 'table' => 'form_options', )); ?><?php $this->assign('prefix', smarty_modifier_default(@$this->_tpl_vars['prefix'], 'select'), false); ?>
...
-<?php endif; ?>' + status + ' ' + $('#sw_' + upd_elm_id + ' a').attr('class'));
		...
		<?php endif; ?>
	<?php endif; ?>
</div><?php if (isset($__parent_tpl_vars)) { $this->_tpl_vars = $__parent_tpl_vars; unset($__parent_tpl_vars);} ?></td>
	<td>
...
<tr class="no-border">
	...
	<td>
		<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('element_type' => "", 'elm_id' => 'add_variants', )); ?>
...
" <?php if ($this->_tpl_vars['element_type'] == @FORM_IP_ADDRESS): ?>selected="selected"<?php endif; ?>><?php echo fn_get_lang_var('ip_address', $this->getLanguage()); ?>
	...
	<td class="center">
		<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('input_name' => "page_data[form][elements_data][".($this->_tpl_vars['num'])."][status]", 'display' => 'select', )); ?>
