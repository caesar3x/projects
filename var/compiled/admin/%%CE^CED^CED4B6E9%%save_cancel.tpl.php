...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'buttons/save_cancel.tpl', 1, false),array('modifier', 'fn_check_view_permissions', 'buttons/save_cancel.tpl', 10, false),array('modifier', 'fn_url', 'buttons/save_cancel.tpl', 42, false),array('modifier', 'strpos', 'buttons/save_cancel.tpl', 123, false),)), $this); ?>
<?php
...
?>
<?php  ob_start();  ?><?php if ($this->_tpl_vars['create'] || $this->_tpl_vars['mode'] == 'add'): ?>
...
<?php if (! $this->_tpl_vars['hide_first_button']): ?>
	<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_text' => smarty_modifier_default(@$this->_tpl_vars['but_text'], @$this->_tpl_vars['but_label']), 'but_onclick' => $this->_tpl_vars['but_onclick'], 'but_role' => 'button_main', 'but_name' => $this->_tpl_vars['but_name'], 'but_meta' => $this->_tpl_vars['but_meta'], )); ?>
...
<?php endif; ?>
	...
	&nbsp;<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_text' => $this->_tpl_vars['but_label2'], 'but_role' => 'button_main', 'but_name' => $this->_tpl_vars['but_name'], 'but_meta' => "cm-save-and-close ".($this->_tpl_vars['but_meta']), 'but_onclick' => $this->_tpl_vars['but_onclick'], 'allow_href' => true, )); ?>
