...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'common_templates/popupbox.tpl', 1, false),array('modifier', 'fn_check_view_permissions', 'common_templates/popupbox.tpl', 2, false),array('modifier', 'fn_url', 'common_templates/popupbox.tpl', 5, false),array('modifier', 'unescape', 'common_templates/popupbox.tpl', 11, false),array('modifier', 'escape', 'common_templates/popupbox.tpl', 120, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('edit','view','view','remove_this_item','remove_this_item','add','remove_this_item','remove_this_item'));
?>
<?php  ob_start();  ?><?php $this->assign('method', smarty_modifier_default(@$this->_tpl_vars['method'], 'POST'), false); ?>
...
<?php elseif ($this->_tpl_vars['act'] == 'create'): ?>
	<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_onclick' => $this->_tpl_vars['edit_onclick'], 'but_text' => $this->_tpl_vars['but_text'], 'but_role' => 'add', 'but_rev' => "content_".($this->_tpl_vars['id']), 'but_meta' => "text-button cm-dialog-opener", )); ?>
...
" class="cm-dialog-opener" rev="content_<?php echo $this->_tpl_vars['id']; ?>
...
<div class="hidden" id="content_<?php echo $this->_tpl_vars['id']; ?>
" title="<?php echo smarty_modifier_escape($this->_tpl_vars['text']); ?>
">
