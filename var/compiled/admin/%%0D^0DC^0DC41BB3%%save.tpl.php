...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'buttons/save.tpl', 26, false),array('modifier', 'fn_check_view_permissions', 'buttons/save.tpl', 27, false),array('modifier', 'fn_url', 'buttons/save.tpl', 33, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('save','remove_this_item','remove_this_item'));
?>
<?php  ob_start();  ?>
<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_text' => fn_get_lang_var('save', $this->getLanguage()), 'but_onclick' => $this->_tpl_vars['but_onclick'], 'but_href' => $this->_tpl_vars['but_href'], 'but_role' => $this->_tpl_vars['but_role'], )); ?>
