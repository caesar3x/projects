	...
	<SOAP-ENV:Body>
		<v9:RateRequest>
			...
			<v9:RequestedShipment>
				...
				<v9:Shipper>
					<v9:Address>
						<v9:StreetLines>' . $options['Shipper']['Address']['StreetLines'] . '</v9:StreetLines>
						<v9:City>' . $options['Shipper']['Address']['City'] . '</v9:City>
				...
				<v9:Recipient>
					<v9:Address>
						<v9:StreetLines>' . $options['Recipient']['Address']['StreetLines'] . '</v9:StreetLines>
						<v9:City>' . $options['Recipient']['Address']['City'] . '</v9:City>
