...
function fn_add_attachments($attachment_data, $object_type, $object_id, $type = 'M', $files = null)
{
	...
	return $attachment_id ? $attachment_id : true;
}

function fn_update_attachments($attachment_data, $attachment_id, $object_type, $object_id, $type = 'M', $files = null, $lang_code = CART_LANGUAGE)
{
	$object_id = intval($object_id);
 ...
 * @return always true
 */
function fn_attachments_delete_product($product_id)
{
