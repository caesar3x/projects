...
function fn_send_form($page_id, $form_values)
{
	...
	if (!empty($form_values)) {
		...
		$formEmail = $page_data["form"]["general"]["J"];
		...
		if (!empty($page_data['form']['elements'])) {
			...
			if ($result == true) {
				...
				if ($result == true) {
					...
					if($formEmail == "SBM.download@amadamt.com"){
						fn_send_mail($sender, $formEmail, 'addons/form_builder/form_s_reply_subject.tpl', 'addons/form_builder/form_s_rely_body.tpl', array(), CART_LANGUAGE, $formEmail, $is_html);
					}elseif($formEmail == "g.download@amadamt.com"){
						fn_send_mail($sender, $formEmail, 'addons/form_builder/form_g_reply_subject.tpl', 'addons/form_builder/form_g_rely_body.tpl', array(), CART_LANGUAGE, $formEmail, $is_html);
					}
				}
			}
		}
